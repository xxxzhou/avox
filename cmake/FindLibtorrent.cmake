...
elseif(IOS)
    set(Libtorrent_PLATFORM_DIR_NAMES "ios/libtorrent" "darwin/libtorrent" "mac/libtorrent")
elseif(APPLE)
    # macOS 必须与 iOS 分开: ios 的 arm64 .a 在 macOS 链接报 "built for iOS";
    # 库仓目录名与 ffmpeg/ass/libsmb2 一致用 darwin(历史名 mac/ 留作兼容)
    set(Libtorrent_PLATFORM_DIR_NAMES "darwin/libtorrent" "mac/libtorrent")
else()
