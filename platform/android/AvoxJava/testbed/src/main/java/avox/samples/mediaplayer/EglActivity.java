...
import avox.android.library.swig.RenderType;
...
public class EglActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoRender.init(mediaPlayer.Player.getSurfaceRender(),glSurfaceView,false);
    }
