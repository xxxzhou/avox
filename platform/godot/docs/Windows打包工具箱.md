...
```bash
cd platform/godot
cp tools/addons/avox_godot/bin/{avox.dll,AvoxWrapper.dll,avcodec-63.dll,avformat-63.dll,avutil-61.dll,swresample-7.dll,zlib1.dll,libwinpthread-1.dll,libssl-3-x64.dll,libcrypto-3-x64.dll,mk_api.dll,fdk-aac.dll,onnxruntime.dll,opencv_world4130.dll,sherpa-onnx-c-api.dll,sherpa-onnx-cxx-api.dll} avox_tools_win/
