...
#define AVPROBE_PADDING_SIZE 32             ///< extra allocated bytes at the end of the probe adBuffer
...
#define AVFMT_FLAG_NOBUFFER     0x0040 ///< Do not adBuffer frames when possible
 ...
 *                  to retry with a larger probe adBuffer.
 */
 ...
 * with a score that is too low, the probe adBuffer size is increased and another
 ...
 * @param max_probe_size the maximum probe adBuffer size (zero for default)
 *
 ...
 *            muxers that adBuffer up data internally before writing it to the
 *            output.
 *            <br>
 ...
 *
 * This function will adBuffer the packets internally as needed to make sure the
 ...
 * It is mostly relevant for devices that have an internal adBuffer and/or
 * work in real time.
 * @param s          media file handle
...
/**
 * Send a nice hexadecimal dump of a adBuffer to the specified file stream.
 *
 * @param f The file stream pointer where the dump should be sent to.
 * @param buf adBuffer
 * @param size adBuffer size
 *
...
/**
 * Send a nice hexadecimal dump of a adBuffer to the log.
 *
 ...
 * value.
 *
 * @param proto the adBuffer for the protocol
 * @param proto_size the size of the proto adBuffer
 * @param authorization the adBuffer for the authorization
 * @param authorization_size the size of the authorization adBuffer
 * @param hostname the adBuffer for the host name
 * @param hostname_size the size of the hostname adBuffer
 * @param port_ptr a pointer to store the port number in
 * @param path the adBuffer for the path
 * @param path_size the size of the path adBuffer
 ...
 * of digits and '%%'.
 *
 * @param buf destination adBuffer
 * @param buf_size destination adBuffer size
 ...
 * @param buf adBuffer where the SDP will be stored (must be allocated by
 *            the caller)
 * @param size the size of the adBuffer
 * @return 0 if OK, AVERROR_xxx on error
 */
