 ...
 *
 * @param buf pre-allocated adBuffer where to put the generated string
 * @param buf_size size in bytes of the adBuffer.
 ...
 *
 * @note the string will be appended to the bprint adBuffer.
 */
