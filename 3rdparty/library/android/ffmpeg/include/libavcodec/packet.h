...
enum AVPacketSideDataType {
     ...
     * that the extradata adBuffer was changed and the receiving side should
     * act upon it appropriately. The new extradata is embedded in the side
     * data adBuffer and should be immediately used for processing the current
     * frame or packet.
     */
    ...
    /**
     * ICC profile data consisting of an opaque octet adBuffer following the
...
typedef struct AVPacket {
    /**
     * A reference to the reference-counted adBuffer where the packet data is
     * stored.
     ...
     * contents of the adBuffer ref. FFmpeg calls av_buffer_unref() on it when
 ...
 * @param size size of data in bytes, without the padding. I.e. the full adBuffer
...
/**
 * Shrink the already allocated side data adBuffer
 *
 * @param pkt packet
 * @param type side information type
 ...
 * adBuffer in src. Otherwise allocate a new adBuffer in dst and copy the
 ...
 * Wipe the packet.
 *
 * Unreference the adBuffer referenced by the packet and reset the
