...
- [ ] A-5 avox_remote: **T1 契约设计已定稿**(`44cf620`, authExpired 生命周期/onAuthExpired/
      refresh 续播通道/alist token/接口清单); 剩 T2 IOParseDav → T3 重试 → T4 缓存 → T5 用例 → [a05](backlog/a05-remote-vfs.md)
