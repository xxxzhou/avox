...
优先级 P1 · 里程碑 M4 · 计划状态:**口径统一(2026-09-19)——只做离线超分,实时搁置**
离线管线(Real-ESRGAN general-x4v3)P0 已收口(09-19, `843b4b2` 尾巴清零,
模型分发口径已定=不入库/不随包),剩 panvox P-17 产品入口集成,见
[ai/离线超分转码方案.md](../ai/离线超分转码方案.md)。实时侧(Anime4K 运行时
分档/GPU 能力探测/RIFE 插帧)维持 2026-09-17 搁置——实测不达质量线,
S/L 档空壳不补、能力探测不做;重开条件=实时质量线达标或用户拍板。
下文「出口判据/现状」为实时侧原始勘察,保留作重开时的底子清单。
