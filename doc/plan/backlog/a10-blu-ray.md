...
> 状态: 有效 · 上次核对: 2026-09-23 · 权威源: -


优先级 P1 · 里程碑:顺延下版本 · 计划状态:**推迟下版本(2026-09-23 拍板,本版不做)**
跳片头/Intro Skipper API 配套;片头片尾静音检测可选。

**拍板记录(2026-09-23)**:统一口径「本版本不做 DVD/蓝光,下版本支持」。范围含 DVD(VIDEO_TS/
libdvdnav,原 A-10 只有蓝光)与蓝光(BDMV/ISO/菜单/章节导航);AACS/CSS 解密盘仍**不做**(合规),
只支持已解密盘/自制盘。现状:全仓无 libbluray/libdvdnav/libdvdcss,ISO 镜像打不开(FFmpeg 无
ISO9660 demuxer);已解密散装 .vob/.m2ts 可当普通文件直播(无菜单无章节)。任务拆解维持,下版本
开工时 DVD 部分并入本卡或另立编号。
