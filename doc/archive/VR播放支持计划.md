...
> 状态: 归档 · 上次核对: 2026-09-18 · 权威源: -

> 2026-09-18 归档: 一期/二期已全量落地并实测验证 (Windows Vulkan + Android 真机, 见文内
> 各任务 ✅), 从 current.md 在办清单移出。遗留仅增强项 (Hough 圆检测校准、equirect 用例待素材)
> 与「暂缓与不做」节的已知限制 (暂停/EOF 参数脏重绘、几何切换走 graph 重建), 需要时从本档重启。
