...
//   AVOX_LAYER_GETNAME(VkSaveFrameLayer)
//  private:
...
//   AVOX_LAYER_GETNAME(VkLowPassLayer)
//  private:
//   /* data */
...
// class VkHighPassLayer : public VkDifferenceBlendLayer, public IParamet<float> {
//   AVOX_LAYER_GETNAME(VkHighPassLayer)
//  private:
